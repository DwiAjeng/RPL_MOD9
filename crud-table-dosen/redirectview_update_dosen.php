...
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" lang="id"><head>
	...
	<META HTTP-EQUIV=Refresh CONTENT='2; URL=view_dosen.php'>
    <style type="text/css">
<!--
...
<p class="message"><h2>UPDATE DATA DOSEN BERHASIL!</h2></p>
...
<form name="loading" id="loading">
	...
	<p><span class="style4"><a href="home_dosen.php">Skip Preload</a></span></p>
	<p>
      <label></label>
  </form>
